...
const btnAgregarInput = document.querySelector('#ingresar');
...
function editarEmpleado() {
    ...
    formulario.querySelector('button[type="submit"]').textContent = 'Ingresar';
...
function limpiarHTML() {
    const divEmpleados = document.querySelector('.listado');
...
function cargarListaLocalStorage() {
